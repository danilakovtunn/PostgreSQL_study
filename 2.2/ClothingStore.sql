...
CREATE TABLE Purchases (
	...
	CONSTRAINT total_price_check CHECK (total_price > 0::money)
);
...
CREATE TABLE Sizes (
	...
	--CONSTRAINT heigh_limit CHECK (heigh_from > 0 AND heigh_to > 0 AND heigh_from < 170 AND heigh_to < 170)	
);
...
ALTER TABLE Employees ADD FOREIGN KEY (chief_id) REFERENCES Employees (employee_id) ON DELETE SET NULL;
ALTER TABLE Employees ADD FOREIGN KEY (store_id) REFERENCES Stores (store_id) ON DELETE CASCADE;
ALTER TABLE Purchases ADD FOREIGN KEY (employee_id) REFERENCES Employees (employee_id) ON DELETE SET NULL;
ALTER TABLE Purchases ADD FOREIGN KEY (customer_id) REFERENCES Customers (customer_id) ON DELETE RESTRICT;
...
ALTER TABLE Products ADD FOREIGN KEY (size_id) REFERENCES Sizes (size_id) ON DELETE RESTRICT;
ALTER TABLE Pull_classes ADD FOREIGN KEY (product_id) REFERENCES Products (product_id) ON DELETE CASCADE;
ALTER TABLE Pull_classes ADD FOREIGN KEY (class_id) REFERENCES Classes (class_id) ON DELETE RESTRICT;
...
VALUES 
	...
	(16, 599.99, '23.04.2021', NULL),
	(17, 549.99, '23.05.2021', NULL),
	(18, 450, '23.10.2021', NULL),
	(19, 400, '23.05.2021', NULL),
